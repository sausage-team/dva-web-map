...
class ModelStatistics extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleInput =(value,e)=>{
    let dataCenter = this.props.statistics.dataCenter;
  ...
  render() {
    let menuConfigValue = this.props.statistics.dataCenter
    return (
      <Modal
        title="案件编辑"
        visible={this.props.statistics.visible}
        onOk={this.handleOk}
...
function ModelComponentFun({ statistics,map}) {
  return { statistics,map};
}
export default connect(ModelComponentFun)(ModelStatistics);
