...
class cameraAnalysisTab extends React.Component {
  ...
  render() {
    return (
      <Table columns={this.columns} pagination={false} bordered loading={this.props.cameraAnalysis.loading} dataSource={this.props.cameraAnalysis.columns} size='small' pagination={this.pagination}/>
    )
  }
}
