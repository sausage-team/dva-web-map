...
class MapControllerTwo extends React.Component {
    constructor(props) {
        super(props);
    }
    ...
    tabFun = (key) => {
        switch (key) {
            ...
            case '3':
                ...
                break;
            case '4':
                this.props.dispatch({ type: 'map/getDackMapTwo' })
    ...
    render() {
        ...
        return (
            <div className={styles.main}>
                <h2 className={styles.hTwo}>图表类型 <Switch style={{ marginTop: '10px', float: 'right' }} checkedChildren="民居" unCheckedChildren="出租" checked={this.props.cameraManagement.mapDataState} defaultChecked onChange={this.switchChenge} /></h2>
...
export default connect(MapControllerFun)(MapControllerTwo);
